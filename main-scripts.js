...
window.addEventListener('load', () => {
    ...
    if (logo) {
        ...
        setTimeout(() => {
            ...
            console.log("Current logo classes:", logo.className);
            console.log("Current logo style opacity:", window.getComputedStyle(logo).opacity);
        }, 1000); // Wait 1 seconds before adding the 'hidden' class
    } else {
...
function viewPIP() {
    ...
    findLargestPipNumber(1000, function(largestPipNumber) {
...
function findLargestPipNumber(maxCheck = 1000, callback) {
